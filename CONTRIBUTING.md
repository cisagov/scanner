...
issue](https://github.com/cisagov/scanner/issues) in this
...
request](https://github.com/cisagov/scanner/pulls), you will
...
```console
cd scanner
pyenv virtualenv <python_version_to_use> scanner
pyenv local scanner
