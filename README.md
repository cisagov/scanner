...
```console
docker run cisagov/scanner:1.3.3
```
...
1. Pull the new image:
    ...
    ```console
    docker pull cisagov/scanner:1.3.3
    ```
...
|-----------|-------------|
|`cisagov/scanner:1.3.3`| An exact release version. |
